...
const EmailValidation = () => {
    ...
    const verifyEmail = async (e) => {
        ...
        const response = axios.put(apiLink + '/verify',data);
    ...
    return (
        <Wrapper>
            ...
            <InfoText>Hello my Friend. Here you can validate your Email-Adress</InfoText>
            <FormWrapper onSubmit={verifyEmail}>
                <InputField type="text" value={inputMail} onChange={e => setInputMail(e.target.value)}
                            placeholder={'Your Email Adress'}/>
                <InputField type="text" maxlenght={6} value={inputDigitCode} placeholder={'Your 6 digit code'}
